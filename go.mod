module github.com/xiaomecc/utils

go 1.20

require (
	github.com/foursking/btype v0.0.0-20201113100634-b48d9a15e856
...
require (
	...
	github.com/foursking/bstring v0.0.0-20201106022705-2683c321a473 // indirect
